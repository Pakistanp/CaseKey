...
public class SteamOpenID implements OpenIDAuth, Serializable {
    ...
    public String verify(String receivingUrl, String responseQuery) {
        if (this.discovered == null) {
            return null;
        }
        try {
            ParameterList responseList = ParameterList.createFromQueryString(responseQuery);
